...
const branch = {
  ...
  title: "المدينة",
  description: "تقدم شركة اليسر للشحن جميع خدمات الشحن من المدينة الى مصر و شحن الأجهزة و شحن الأثاث و الامتعة الشخصية من المدينة الى مصر",
  keywords: "شحن من المدينة الى مصر ، الشحن من المدينة الى مصر",
  openGraph: {
    title: "المدينة",
    description:  "تقدم شركة اليسر للشحن جميع خدمات الشحن من المدينة الى مصر و شحن الأجهزة و شحن الأثاث و الامتعة الشخصية من المدينة الى مصر",
    url: "https://alyusrforshipping.com/madinah",
    siteName: "شركة اليسر للشحن الدولي",
    locale: "ar_SA",
    type: "website",
  },
  alternates: {
        canonical:  "https://alyusrforshipping.com/madinah",
      },
};
