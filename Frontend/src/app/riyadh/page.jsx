...
const branch = {
  ...
  title: "الرياض",
  description: "تقدم شركة اليسر للشحن جميع خدمات الشحن من الرياض الى مصر و شحن الأجهزة و شحن الأثاث و الامتعة الشخصية من الرياض الى مصر",
  keywords: "شحن من الرياض الى مصر ، الشحن من الرياض الى مصر",
  openGraph: {
    title: "الرياض",
    description:  "تقدم شركة اليسر للشحن جميع خدمات الشحن من الرياض الى مصر و شحن الأجهزة و شحن الأثاث و الامتعة الشخصية من الرياض الى مصر",
    url: "https://alyusrforshipping.com/riyadh",
    siteName: "شركة اليسر للشحن الدولي",
    locale: "ar_SA",
    type: "website",
  },
  alternates: {
        canonical:  "https://alyusrforshipping.com/riyadh",
      },
};
